...
lazy_static! {
    ...
    static ref TRIGGER_FILE_SIZE : u64 = configration::gett::<u64>("logger.logFileSize");
    static ref ROLLER_FILEPATH_PATTERN: String  = configration::gett::<String>("logger.roller_filepath_pattern");
    static ref ROLLER_MAX_COUNT: u32 = configration::gett::<u32>("logger.roller_max_count") as u32;
    static ref ROLLER_BASE_START: u32 = configration::gett::<u32>("logger.roller_base_start") as u32;
    static ref ALL_LOG_FILE_PATH:String = configration::gett::<String>("logger.all_logs_common_file_path");
}
