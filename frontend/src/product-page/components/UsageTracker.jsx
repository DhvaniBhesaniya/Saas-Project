...
export default function UsageTracker() {
  const { usageCount, maxUsage, isLimitReached } = useUsage();
    ...
    <Card variant="outlined" sx={{ width: "100%", bgcolor: "background.paper" }}>
      <CardContent sx={{ p: 1, "&:last-child": { pb: 1 } }}>
        ...
        <Box sx={{ width: "100%", mb: 1 }}>
          <LinearProgress variant="determinate" value={(usageCount / maxUsage) * 100} color="secondary" />
        </Box>
        <Button variant="contained" size="small" fullWidth disabled={!isLimitReached}>
          Upgrade Plan
        </Button>
      </CardContent>
    </Card>
